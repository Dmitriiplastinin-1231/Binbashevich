...
class ModernTrafficMonitorGUI:
    ...
    def create_modern_interface(self):
        ...
        left_panel = tk.Frame(main_frame, bg="#0a0e27", width=350)
        ...
        self.create_graphs_panel(center_panel)
        
        # Правая панель - события и логи
        right_panel = tk.Frame(main_frame, bg="#0a0e27", width=400)
    ...
    def update_graphs(self):
        ...
        self.ax_traffic.fill_between(range(len(self.packet_history)), list(self.packet_history), alpha=0.3, color='#3b82f6')
        self.canvas_traffic.draw()
        
        # График угроз
        self.ax_threats.clear()
        self.setup_graph(self.ax_threats, "Угрозы", '#ef4444')
        self.ax_threats.plot(list(self.threat_history), color='#ef4444', linewidth=2)
        self.ax_threats.fill_between(range(len(self.threat_history)), list(self.threat_history), alpha=0.3, color='#ef4444')
        self.canvas_threats.draw()
